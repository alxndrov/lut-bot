...
# Остаток на счёте СДЭК, ниже которого пора пополнять: на пустом счёте
# накладные перестанут создаваться. Про порог напоминают /cdek и отчёты.
CDEK_LOW_BALANCE: float = float(os.getenv("CDEK_LOW_BALANCE", "1000"))
